...
{
    //获得省所对应的列表框对象
    var pro=document.getElementById("customprovince");
    //从数组中提取省份信息
...
function loadCity()
{
    ...
    var selectProvince=document.getElementById("customprovince").value;
    //根据省获得市(citys是一个数组)
    var citys=provinces[selectProvince];
    //获得市所对应的列表框对象baojian123.in
    var city=document.getElementById("customcity");
    //将元素列表框中的元素全部清空
    city.innerText="";
