...
<div class="formdiv">
	<form action="" method="post" id="openappForm">
		<div>
			<ul>
				<input type="hidden" name="keywordId" id="keywordId" value="${keyword.keywordId}">
				<input type="hidden" name="openApp" value="1">
				<input type="hidden" name="keyword" value="${keyword.keyword}">
				<input type="hidden" name="	customer.companyName" value="${keyword.customer.companyName}">
				...
				<li>登录账号:<input type="text" name="appCode" id="appCode" value="${appInfo.appCode}"></li>
				<li>登录密码:<input type="text" name="appPassword" id="appPassword" value="${appInfo.appPassword}"></li>
		...
		<div class="clear"></div>
		<div class="submitdiv"> <input type="submit" id="openappSubmit" value="开通APP" ></div>
	</form>
</div>
